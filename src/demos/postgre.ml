(* sample run command -> jonathanmiranda@jonathans-air demos % dune exec ./postgre.exe "host=localhost port=5432 dbname=mydatabase user=postgres password=12345678" *)
(* follow this tutorial to set up postgresql locally -> https://scriptable.com/how-to-install-postgresql-mac-docker/ *)
